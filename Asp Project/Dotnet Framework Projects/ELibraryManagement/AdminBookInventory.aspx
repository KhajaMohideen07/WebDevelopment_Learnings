         ...
         <div class="col-md-6">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row" style="margin-bottom: 10px">
                     <div class="col-4">
                        <asp:Button ID="Button1"  class="btn btn-success w-100"  runat="server" Text="Add" />
                     </div>
                     <div class="col-4">
                        <asp:Button ID="Button3" class="btn btn-warning w-100"  runat="server" Text="Update" />
                     </div>
                     <div class="col-4">
                        <asp:Button ID="Button2" class="btn btn-danger w-100" runat="server" Text="Delete" />
                     </div>
                  </div>
               </div>
            </div>
