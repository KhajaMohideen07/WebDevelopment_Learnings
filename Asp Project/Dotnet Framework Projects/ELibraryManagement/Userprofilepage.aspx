<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Userprofilepage.aspx.cs" Inherits="ELibraryManagement.Userprofilepage" %>
                            ...
                            <div class="col">
                                <center>
                                    ...
                                    <p>
                                        Account Status : 
                                    <span>
                                        <asp:Label ID="Label1" class="badge bg-info text-dark" runat="server" Text="Your Status"></asp:Label></span>
                                    </p>
                                </center>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group" style="margin-bottom: 10px">
                                    <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Your Full Name"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-6">
